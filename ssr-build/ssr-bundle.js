...
var Button_style = __webpack_require__("GzFB");
...
var Toolbar_style = __webpack_require__("o/XI");
...
var Recompose_mapProps = function mapProps(propsMapper) {
  return function (BaseComponent) {
...
var withProps = function withProps(input) {
  var hoc = Recompose_mapProps(function (props) {
...
var Recompose_withPropsOnChange = function withPropsOnChange(shouldMapOrKeys, propsMapper) {
  return function (BaseComponent) {
    var factory = createFactory(BaseComponent);
...
var Recompose_withHandlers = function withHandlers(handlers) {
  return function (BaseComponent) {
    var factory = createFactory(BaseComponent);
...
var Recompose_defaultProps = function defaultProps(props) {
  return function (BaseComponent) {
    var factory = createFactory(BaseComponent);
...
var Recompose_flattenProp = function flattenProp(propName) {
  return function (BaseComponent) {
    var factory = createFactory(BaseComponent);
...
var Recompose_withState = function withState(stateName, stateUpdaterName, initialState) {
  return function (BaseComponent) {
    var factory = createFactory(BaseComponent);
...
var Recompose_withStateHandlers = function withStateHandlers(initialState, stateUpdaters) {
  return function (BaseComponent) {
    var factory = createFactory(BaseComponent);
...
var Recompose_withReducer = function withReducer(stateName, dispatchName, reducer, initialState) {
  return function (BaseComponent) {
    var factory = createFactory(BaseComponent);
...
var Recompose_branch = function branch(test, left) {
...
var Recompose_renderComponent = function renderComponent(Component$$1) {
  return function (_) {
...
var Recompose_shouldUpdate = function shouldUpdate(test) {
  return function (BaseComponent) {
    var factory = createFactory(BaseComponent);
...
var Recompose_pure = function pure(BaseComponent) {
  var hoc = Recompose_shouldUpdate(function (props, nextProps) {
...
var Recompose_onlyUpdateForKeys = function onlyUpdateForKeys(propKeys) {
  var hoc = Recompose_shouldUpdate(function (props, nextProps) {
...
var onlyUpdateForPropTypes = function onlyUpdateForPropTypes(BaseComponent) {
  ...
  var OnlyUpdateForPropTypes = Recompose_onlyUpdateForKeys(propKeys)(BaseComponent);
...
var Recompose_withContext = function withContext(childContextTypes, getChildContext) {
  return function (BaseComponent) {
    var factory = createFactory(BaseComponent);
...
var Recompose_getContext = function getContext(contextTypes) {
  return function (BaseComponent) {
    var factory = createFactory(BaseComponent);
...
/* eslint-disable no-console */
var Recompose_lifecycle = function lifecycle(spec) {
  return function (BaseComponent) {
    var factory = createFactory(BaseComponent);
...
var Recompose_toClass = function toClass(baseComponent) {
  ...
  var ToClass = function (_Component) {
    ...
    ToClass.prototype.render = function render() {
      if (typeof baseComponent === 'string') {
        return preact_compat_es.createElement(baseComponent, this.props);
      }
...
var Recompose_createSink = function createSink(callback) {
...
var Recompose_componentFromProp = function componentFromProp(propName) {
...
var Recompose_nest = function nest() {
...
var Recompose_hoistStatics = function hoistStatics(higherOrderComponent) {
  return function (BaseComponent) {
    var NewComponent = higherOrderComponent(BaseComponent);
    hoist_non_react_statics_default()(NewComponent, BaseComponent);
    return NewComponent;
  };
};
...
var Recompose_componentFromStreamWithConfig = function componentFromStreamWithConfig(config$$1) {
  return function (propsToVdom) {
    return function (_Component) {
      ...
      function ComponentFromStream() {
        ...
        return _ret = (_temp = (_this = possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = { vdom: null }, _this.propsEmitter = Object(lib["createChangeEmitter"])(), _this.props$ = config$$1.fromESObservable((_config$fromESObserva = {
        ...
        }, _config$fromESObserva[symbol_observable_default.a] = function () {
          return this;
...
var Recompose_componentFromStream = function componentFromStream(propsToVdom) {
  return Recompose_componentFromStreamWithConfig(config)(propsToVdom);
};
...
var Recompose_mapPropsStreamWithConfig = function mapPropsStreamWithConfig(config$$1) {
  var componentFromStream = Recompose_componentFromStreamWithConfig({
...
var mapPropsStream = function mapPropsStream(transform) {
  var hoc = Recompose_mapPropsStreamWithConfig(config)(transform);
...
var Recompose_createEventHandlerWithConfig = function createEventHandlerWithConfig(config$$1) {
  return function () {
    var _config$fromESObserva;
...
var createEventHandler = Recompose_createEventHandlerWithConfig(config);

// Higher-order component helpers


// CONCATENATED MODULE: ./model/State.js


var updater = function updater(name) {
...
var State_Canvas = Recompose_withStateHandlers(function (props) {
  return {
    drawing: false,
    canvasWidth: 500,
    canvasHeight: 300,
  ...
  setPrevCoord: function setPrevCoord(state) {
  ...
  resizeCanvas: function resizeCanvas(state) {
  ...
  clearStart: function clearStart(state) {
    return function () {
      return { clearing: true };
    };
  },
  clearDone: function clearDone(state) {
    return function () {
      return { clearing: false };
    };
  },
  recordStart: function recordStart(state) {
    return function () {
      return { recording: true };
    };
  },
  recordFinish: function recordFinish(state) {
    return function () {
      return { recording: false };
    };
  },
  falseMediaRecorderSupported: function falseMediaRecorderSupported() {
    return function () {
      return { isMediaRecorderSupported: false };
    };
  }
});

/* harmony default export */ var State = (compose(State_Canvas));
// CONCATENATED MODULE: ./components/Canvas.jsx
...
var enabledOf = function enabledOf(name) {
  return function (prev, next) {
    return !prev[name] && next[name];
  };
};
var disabledOf = function disabledOf(name) {
  return function (prev, next) {
    return prev[name] && !next[name];
  };
};
var enabledOfClearing = enabledOf('clearing');
var enabledOfRecording = enabledOf('recording');
var disabledOfRecording = disabledOf('recording');

var Canvas_Canvas = function (_Component) {
  ...
  function Canvas() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.startDrawing = function (e) {
      var _this$props = _this.props,
          toggleDrawing = _this$props.toggleDrawing,
          setPrevCoord = _this$props.setPrevCoord;
      ...
      setPrevCoord(coord);
      toggleDrawing(true);
    }, _this.finishDrawing = function (e) {
      var _this$props2 = _this.props,
          toggleDrawing = _this$props2.toggleDrawing,
          drawing = _this$props2.drawing;

      if (drawing) {
        toggleDrawing(false);
      }
    }, _this.keepDrawing = function (e) {
      var _this$props3 = _this.props,
          drawing = _this$props3.drawing,
          setPrevCoord = _this$props3.setPrevCoord,
          prevX = _this$props3.prevX,
          prevY = _this$props3.prevY;
      ...
      _this.drawLine(prevCoord, coord);
      setPrevCoord(coord);
    }, _this.updateCanvasSize = function (e) {
      var _e$currentTarget$getB = e.currentTarget.getBoundingClientRect(),
          w = _e$currentTarget$getB.width,
          h = _e$currentTarget$getB.height;

      var _this$props4 = _this.props,
          canvasWidth = _this$props4.canvasWidth,
          canvasHeight = _this$props4.canvasHeight;

      var shouldUpdate = Math.abs(w - canvasWidth) > 4 || Math.abs(h - canvasHeight) > 4;
      if (shouldUpdate) {
        _this.props.resizeCanvas({ w: w, h: h });
      }
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  Canvas.prototype.render = function render(_ref) {
    var _this2 = this;
    ...
    return Object(preact_min["h"])(
      'div',
      { 'class': 'Canvas-wrap', onMouseUp: this.updateCanvasSize, style: { width: canvasWidth + 'px', height: canvasHeight + 'px' } },
      Object(preact_min["h"])('canvas', {
        id: 'paint-canvas',
        width: canvasWidth - 8,
  ...
  Canvas.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
  ...
  Canvas.prototype.drawLine = function drawLine(from, to) {
  ...
  Canvas.prototype.startRecord = function startRecord() {
    var _this3 = this;

    var stream = this.canvas.captureStream(30);
    var mediaRecorder = new window.MediaRecorder(stream, { mimeType: 'video/webm' });
    mediaRecorder.start(100); // 100ms
    mediaRecorder.ondataavailable = function (e) {
      if (e.data && e.data.size > 0) {
        _this3.recordedBlobs.push(e.data);
      }
    };
    this.mediaRecorder = mediaRecorder;
  };

  Canvas.prototype.stopRecordAndDownload = function stopRecordAndDownload() {
    var _this4 = this;
    ...
    mediaRecorder.onstop = function () {
      ...
      var blob = new Blob(_this4.recordedBlobs, { type: 'video/webm' });
...
/* harmony default export */ var components_Canvas = (Canvas_Canvas);
...
var foundation_MDCRippleFoundation = function (_MDCFoundation) {
  ...
  function MDCRippleFoundation(adapter) {
    ...
    /** @private {number} */
    var _this = foundation__possibleConstructorReturn(this, _MDCFoundation.call(this, foundation__extends(MDCRippleFoundation.defaultAdapter, adapter)));
...
function toolbar_foundation__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function toolbar_foundation__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var foundation_MDCToolbarFoundation = function (_MDCFoundation) {
  toolbar_foundation__inherits(MDCToolbarFoundation, _MDCFoundation);
  ...
  function MDCToolbarFoundation(adapter) {
    ...
    var _this = toolbar_foundation__possibleConstructorReturn(this, _MDCFoundation.call(this, toolbar_foundation__extends(MDCToolbarFoundation.defaultAdapter, adapter)));
...
var Title = preact_material_components_Toolbar.Title,
    Row = preact_material_components_Toolbar.Row;
...
/* harmony default export */ var components_Header = (Recompose_pure(Header));
// CONCATENATED MODULE: ./components/NotSupportedMessage.jsx
...
var _ref2 = Object(preact_min["h"])(
  ...
  'MediaStream Recording API is not supported on this browser.',
  ...
  Object(preact_min["h"])(
    'a',
    { href: 'https://developer.mozilla.org/en-US/docs/Web/API/MediaRecorder', target: '_blank' },
    'MediaRecorder - Web APIs | MDN'
  ),
  ' for detail.'
);

var NotSupportedMessage = function NotSupportedMessage(_ref) {
  var enabled = _ref.enabled;
  return enabled ? _ref2 : null;
};

/* harmony default export */ var components_NotSupportedMessage = (Recompose_pure(NotSupportedMessage));
...
// CONCATENATED MODULE: ./components/PaintToolbar.jsx




var PaintToolbar_PaintToolbar = function PaintToolbar(_ref) {
  var clearStart = _ref.clearStart,
      recordStart = _ref.recordStart,
      recordFinish = _ref.recordFinish,
      recording = _ref.recording,
      isMediaRecorderSupported = _ref.isMediaRecorderSupported;
  return Object(preact_min["h"])(
    'div',
    { 'class': 'PaintToolbar' },
    Object(preact_min["h"])(
      'span',
      { 'class': 'PaintToolbar-button' },
      Object(preact_min["h"])(
        preact_material_components_Button,
        { raised: true, ripple: true, onClick: recording ? recordFinish : recordStart, disabled: !isMediaRecorderSupported },
    ...
    Object(preact_min["h"])(
      ...
      Object(preact_min["h"])(
        preact_material_components_Button,
        { stroked: true, onClick: clearStart },
        'CLEAR'
      )
    ),
    Object(preact_min["h"])(
      'span',
      { 'class': 'PaintToolbar-message' },
      Object(preact_min["h"])(
        'span',
        { 'class': 'PaintToolbar-message-inner' },
        recording && 'Recording...'
      )
    )
  );
...
/* harmony default export */ var components_PaintToolbar = (Recompose_pure(PaintToolbar_PaintToolbar));
...
/* harmony default export */ var components = ({
  Canvas: components_Canvas,
  Header: components_Header,
  NotSupportedMessage: components_NotSupportedMessage,
  PaintToolbar: components_PaintToolbar
});
...
var index__ref2 = Object(preact_min["h"])(components_Header, null);

var index_App = State(_class = function (_Component) {
  ...
  App.prototype.render = function render(_ref) {
    var drawing = _ref.drawing,
        ...
        canvasHeight = _ref.canvasHeight,
        clearing = _ref.clearing,
        recording = _ref.recording,
        isMediaRecorderSupported = _ref.isMediaRecorderSupported,
        toggleDrawing = _ref.toggleDrawing,
        setPrevCoord = _ref.setPrevCoord,
        resizeCanvas = _ref.resizeCanvas,
        clearStart = _ref.clearStart,
        clearDone = _ref.clearDone,
        recordStart = _ref.recordStart,
        recordFinish = _ref.recordFinish;
    ...
    return Object(preact_min["h"])(
      ...
      Object(preact_min["h"])(
        'div',
        { 'class': 'App-main' },
        Object(preact_min["h"])(components_NotSupportedMessage, { enabled: !isMediaRecorderSupported }),
        Object(preact_min["h"])(components_PaintToolbar, {
        ...
        Object(preact_min["h"])(components_Canvas, {
          drawing: drawing,
          prevX: prevX,
          prevY: prevY,
